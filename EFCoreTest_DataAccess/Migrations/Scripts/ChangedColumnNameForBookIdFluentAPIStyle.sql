...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20231009151019_ChangedColumnNameForBookIdFR') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20231009151019_ChangedColumnNameForBookIdFR', '8.0.0-rc.1.23419.6');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20231009151210_ChangedColumnNameForBookIdFluentAPIStyle') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20231009151210_ChangedColumnNameForBookIdFluentAPIStyle', '8.0.0-rc.1.23419.6');
    END IF;
END $EF$;
COMMIT;
