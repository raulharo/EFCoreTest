...
namespace EFCoreTest_DataAccess.Migrations
{
    ...
    [Migration("20231009151210_ChangedColumnNameForBookIdFluentAPIStyle")]
    partial class ChangedColumnNameForBookIdFluentAPIStyle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreTest_Model.Models.Fluent_Models.Fluent_BookAuthorMap", b =>
                {
                    b.Property<int>("Author_Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EFCoreTest_Model.Models.Fluent_Book", b =>
                {
                    b.HasOne("EFCoreTest_Model.Models.Fluent_Publisher", "Publisher")
                        .WithMany("Books")
                        .HasForeignKey("Publisher_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EFCoreTest_Model.Models.Fluent_BookDetail", b =>
                {
                    b.HasOne("EFCoreTest_Model.Models.Fluent_Book", "Book")
                        .WithOne("BookDetail")
                        .HasForeignKey("EFCoreTest_Model.Models.Fluent_BookDetail", "BookDetail_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EFCoreTest_Model.Models.Fluent_Models.Fluent_BookAuthorMap", b =>
                {
                    b.HasOne("EFCoreTest_Model.Models.Fluent_Author", "Author")
            ...
            modelBuilder.Entity("Fluent_AuthorFluent_Book", b =>
                {
                    b.HasOne("EFCoreTest_Model.Models.Fluent_Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsAuthor_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreTest_Model.Models.Fluent_Book", null)
                        .WithMany()
                        .HasForeignKey("BooksBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
